...
%ISOCLINAS. busco la ecuaci�n de una recta depejando N2 para graficar
%convenientemente
solve('0.3*N1*(30-N1-N2)/30','N2')
%ans =30 - N1
solve('0.2*N2*(50-N2-2*N1)/50','N2')
% 50 - 2*N1
%Aqu� agregu� el despejando N1
...
%el sistema no se desv�a a su capacidad de carga. Sin embargo en general
%prevalece una poblaci�n a otra
hold on
x=(0:1:30); 
y1=30-x; %N1=x isoclina de la especie 1
y2=50 - 2*x; %isoclina de la especie 2
